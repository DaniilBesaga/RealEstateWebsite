import '../style/EstateLabel.css';

function EstateLabel({ estate, setShowContactForm }) {
    ...
    return (
        <div className="elabel-container">
            <div className="elabel">
                <div className="label-address">
                    <h1>{estate.estateAddress}</h1>
                </div>
                <div className="label-main-content">
                    <div className="label-price-uah">
                        ...
                        {estate.priceUah}<span>₴</span>
                    </div>
                    <div className="label-price-usd">
                        {estate.priceUsd}<span>$</span>
                    </div>
                    <button className="label-button" onClick={handleButtonClick}>
