...
function ServicesInfo() {
    ...
    const [showComponent, setShowComponent] =
        React.useState({
            showConsultComponent: window.location.href.includes("consult") ? true : false,
            showInvestComponent: window.location.href.includes("invest") ? true : false,
            showExchangeComponent: window.location.href.includes("exchange") ? true : false,
