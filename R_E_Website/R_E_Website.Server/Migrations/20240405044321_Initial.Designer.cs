...
namespace R_E_Website.Server.Migrations
{
    ...
    [Migration("20240405044321_Initial")]
            ...
            modelBuilder.Entity("R_E_Website.Server.Models.Estate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComplexName = "044",
                            ComplexUrl = "/",
                            Discription = "Затишна квартира на 1 кімнату у місті Київ, район Подільський, знаходиться на 5 поверсі. Площа становить 58 м2.Просторна кухня-вітальня оснащена необхідною вбудованою побутовою технікою та меблями високої якості. На підлогах ламінат та кахель. У просторому санвузлі ванна, раковина, унітаз, пральна машина. Житловий комплекс із системою відеоспостереження та охороною по периметру. На території дитячі майданчики, тренажери, поряд каскад озер та паркова зона. ",
                        ...
                        new
                        {
                            ...
                            ComplexName = "4U",
                            ComplexUrl = "/",
                            Discription = "Чудова двокімнатна квартира в самому центрі Києва, вражає своєю просторістю та затишком. Загальна площа складає 75 м2, з просторою вітальнею та вбудоваою кухнею. В квартирі є все необхідне для комфортного проживання. Для майбутніх мешканців є підземний паркінг та парковочні місця біля будинку.",
                        ...
                        new
                        {
                            Id = 6,
                            City = "Київ",
                            Discription = "Двоповерховий будинок. Скважина - 60м.п. підведено в будинок, її при ямок можливо використовувати, як погріб.лектрика 32 кВт розведена по будинку і частково на другому поверсі + зроблене заземлення. В будинок кабель заходить під землею.\r\nТеплі водяні поли з ел.котлем Bosh 24 кВт\r\nВ будинку на першому поверсі чистова стяжка, на другому дерев'яне перекриття.\r\nЧастково присутня штукатурка.",
                        ...
                        new
                        {
                            Id = 7,
                            City = "Славгород",
                            Discription = "Опалення - газовий двоконтурний котел, оплата за лічильником, також на будинок заведено 2 фази по 16 кВт електроенергії, встановлений лічильник День - Ніч, прямий договір з ДТЕК. Стіни - цегла(380 мм) + утеплення(60 мм).Зовні - кароїд + фарбування. Дах - бітумна черепиця. У будинку встановлено справжній камін",
                        ...
                        new
                        {
                            Id = 8,
                            City = "Миргород",
                            Discription = "Будинок деревяний але обкладений цеглою, у будинку, газові конвектори, грубка для альтернативного опалення будинку, встановлено металопластикові вікна. Також є топоміжні примішення, літня кухня та господарська споруда, а також погріб для зберігання продуктів. Ділянка розташована у зручному місці, поруч школа, садок, магазини і транспортна зупинка.",
                        ...
                        new
                        {
                            Id = 9,
                            City = "Виноградів",
                            Discription = "Продається земельна ділянка під будівництво будинку. Площа 11 соток, р-н геріатричного пансіонату, \"Школярка\") Комунікації на ділянці відсутні (електрика, газ підведені поруч із ділянкою) Прекрасне розташування. Поруч збудовані будинки",
                        ...
                        new
                        {
                            Id = 10,
                            City = "Новоселиця",
                            Discription = "Продається земельна ділянка в чудовому мальовничому місці. Перші Новоселицьі дачі. Діляночка рівненька, доглянута. Вода від башти Світло на ділянці; Газ поруч; Зручний заїзд з центральної дороги",
                        ...
                        new
                        {
                            Id = 11,
                            City = "Київ",
                            Discription = "Продаж земельної ділянки сільськогосподарського призначення! Є вода від башні та септик. Газ та світло поруч з ділянкою. На ділянці деревʼяний будинок. Частково зроблений паркан. Вулиця обжита. Дуже гарне місце та спокійне місце розташування.",
                        ...
                        new
                        {
                            Id = 13,
                            City = "Київ",
                            Discription = "Продається паркове місце. По вулиці Васильченка 3. Парко місце під охороною, Закрита територія. Один заїзд. 15 КВ метрів. Парк місце знаходиться в кінці паркінгу. ",
                        ...
                        new
                        {
                            Id = 14,
                            City = "Київ",
                            Discription = "Продається доглянутий гараж з підвальним приміщенням в гаражному кооперативі \"Троянда\", що знаходиться по вулиці Берковецька 6. Територія охороняється, також є відеонагляд. Поруч знаходяться житлові комплекси ЖК \"Lalalend\", та ЖК \"Lucy Land\", в трьох хвилинах ходьби розташований ТРЦ \"Lavina\"",
                        ...
                        new
                        {
                            Id = 15,
                            City = "Київ",
                            Discription = "Продається паркомісце в Подільському районі, Липинка. Паркомісце знаходиться у багаторівневому паркінгу на третьому відкритому поверсі, біля Крістер Града, ЖК Варшавського та ЖК Липинки. Зручне на виїзд та виїзд. Є ліфт та цілодобова охорона. Право власності. Податки сплачуємо за себе.",
